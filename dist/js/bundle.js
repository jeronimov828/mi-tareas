...
const usuario_module_1 = __importDefault(__webpack_require__(1));
const tareas_module_1 = __importDefault(__webpack_require__(5));
module.exports = {
    tareasModule: tareas_module_1.default,
    ...
    iniciarSesion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield config_1.axiosInstance.post("login", datos);
                console.log("Respuesta del servidor:", response);
                // Verificar si la respuesta contiene el token
                if ((_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.item) === null || _b === void 0 ? void 0 : _b.token) {
...
const config_1 = __webpack_require__(2);
const sweetalert2_1 = __importDefault(__webpack_require__(4));
const ListarTareas = __webpack_require__(6);
const editarTareas = __webpack_require__(29);
class tareasModule {
    constructor() {
        this._tareas = [];
        this._tareasEstado = [];
    ...
    listarTareas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield config_1.axiosInstance.get("listarTareas", {
                    headers: {
                ...
                if ((_a = response.data) === null || _a === void 0 ? void 0 : _a.status) {
                    ...
                    document.querySelector("#tablaTareas").innerHTML = ListarTareas({ tareas });
    ...
    cambiarEstadoTarea(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const checkbox = document.querySelector(`#estadoTareas-${id}`);
                const editar = {
                    completada: checkbox.checked
                };
                const response = yield config_1.axiosInstance.put(`editarTareas${id}`, editar, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                if ((_a = response.data) === null || _a === void 0 ? void 0 : _a.status) {
                    ...
                    sweetalert2_1.default.fire("¡Éxito!", "La tarea fue actualizada correctamente", "success");
                }
                else {
                    sweetalert2_1.default.fire("Oops...", "No se pudo actualizar la tarea", "error");
                }
            }
            catch (error) {
                console.error("Error en la solicitud:", error);
    ...
    mostrarModalEditar(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                config_1.axiosInstance.get(`listarTareas/${id}`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                }).then(({ data }) => {
                    if (data.status) {
                        ...
                        const formEditarElement = document.querySelector("#formEditar");
                        ...
                        document.querySelector("#formEditar").setAttribute('data-id', id.toString());
                    }
                }).catch(error => {
    ...
    crearTarea() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const datos = {
                    titulo: document.querySelector("#nombreTarea").value,
                    descripcion: document.querySelector("#descripcionTarea").value,
                    fecha_vencimiento: document.querySelector("#fechaVenceTarea").value
                };
                const response = yield config_1.axiosInstance.post("tareas", datos, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                if (response.status == 201) {
                    sweetalert2_1.default.fire("¡Éxito!", "Tarea creada correctamente", "success");
                }
                else {
                    sweetalert2_1.default.fire("Oops...", "No se pudo crear la tarea", "error");
                }
            }
            catch (error) {
                console.error("Error en la solicitud:", error);
    ...
    mostrarInformacionEditarTarea(id) {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.axiosInstance.get(`listarTareas/${id}`).then(({ data }) => {
                if (data.status) {
...
exports["default"] = new tareasModule();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <tr>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":16,"column":16},"end":{"line":16,"column":22}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"titulo") || (depth0 != null ? lookupProperty(depth0,"titulo") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"titulo","hash":{},"data":data,"loc":{"start":{"line":17,"column":16},"end":{"line":17,"column":26}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"descripcion") || (depth0 != null ? lookupProperty(depth0,"descripcion") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"descripcion","hash":{},"data":data,"loc":{"start":{"line":18,"column":16},"end":{"line":18,"column":31}}}) : helper)))
    + "</td>\r\n            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"fecha_vencimiento") || (depth0 != null ? lookupProperty(depth0,"fecha_vencimiento") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"fecha_vencimiento","hash":{},"data":data,"loc":{"start":{"line":19,"column":16},"end":{"line":19,"column":37}}}) : helper)))
    + "</td>\r\n            <td>\r\n                <div class=\"form-check form-switch\">\r\n                    <input class=\"form-check-input\" type=\"checkbox\" role=\"switch\" id=\"estadoTareas-"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":22,"column":99},"end":{"line":22,"column":105}}}) : helper)))
    + "\" "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"completada") : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":22,"column":107},"end":{"line":23,"column":50}}})) != null ? stack1 : "")
    + " onclick=\"app.tareasModule.cambiarEstadoTarea("
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":23,"column":96},"end":{"line":23,"column":102}}}) : helper)))
    + ")\">\r\n\r\n                    <label class=\"form-check-label\" id=\"estadoLabel-"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":25,"column":68},"end":{"line":25,"column":74}}}) : helper)))
    + "\" for=\"estadoTareas-"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":25,"column":94},"end":{"line":25,"column":100}}}) : helper)))
    + "\">\r\n                        "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"completada") : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data,"loc":{"start":{"line":26,"column":24},"end":{"line":26,"column":76}}})) != null ? stack1 : "")
    + "\r\n                    </label>\r\n                </div>\r\n            </td>\r\n            <td>\r\n                <button type=\"button\" class=\"btn btn-secondary\" id=\"modalEditar\" onclick=\"app.tareasModule.mostrarModalEditar("
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":31,"column":126},"end":{"line":31,"column":132}}}) : helper)))
  ...
  return "<table class=\"table table-striped my-0 dataTable no-footer\" aria-describedby=\"datatables-dashboard-projects_info\">\r\n    <h5 class=\"card-title mb-0\">Tareas</h5>\r\n    <thead>\r\n        <tr>\r\n            <th class=\"sorting sorting_asc\">Numero</th>\r\n            <th class=\"sorting sorting_asc\">titulo</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">descripcion</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">fecha vencimiento</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">completada</th>\r\n            <th class=\"d-none d-xl-table-cell sorting\">Editar</th>\r\n        </tr>\r\n    </thead>\r\n    <tbody>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"tareas") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":14,"column":8},"end":{"line":34,"column":17}}})) != null ? stack1 : "")
    + "    </tbody>\r\n</table>";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputEmail1\" class=\"form-label\">Nombre Tarea</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"nombreTarea\" ria-describedby=\"emailHelp\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"titulo") || (depth0 != null ? lookupProperty(depth0,"titulo") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"titulo","hash":{},"data":data,"loc":{"start":{"line":5,"column":106},"end":{"line":5,"column":116}}}) : helper)))
    + "\">\r\n    </div>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputPassword1\" class=\"form-label\">Descripción</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"descripcionTarea\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"descripcion") || (depth0 != null ? lookupProperty(depth0,"descripcion") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"descripcion","hash":{},"data":data,"loc":{"start":{"line":9,"column":83},"end":{"line":9,"column":98}}}) : helper)))
    + "\">\r\n    </div>\r\n    <div class=\"mb-3\">\r\n        <label for=\"exampleInputPassword1\" class=\"form-label\">Fecha Vence</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"fechaVenceTarea\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"fecha_vence") || (depth0 != null ? lookupProperty(depth0,"fecha_vence") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"fecha_vence","hash":{},"data":data,"loc":{"start":{"line":13,"column":82},"end":{"line":13,"column":97}}}) : helper)))
    + "\">\r\n    </div>\r\n</form>\r\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"modalEditar") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":16,"column":9}}})) != null ? stack1 : "");
},"useData":true});
...
/******/ 		          var id = "webpack-livereload-plugin-script-0e84479fb2cac326";
